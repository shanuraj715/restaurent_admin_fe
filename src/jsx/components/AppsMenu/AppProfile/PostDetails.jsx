                        ...
                        <Modal className="modal fade" show={state.sendMessage} centered>
                          <div className="modal-content">
                            <div className="modal-header">
                              ...
                              <Button variant="" type="button" className="btn-close" onClick={() => dispatch({type:'sendMessageClose'})}></Button>
                            </div>
                              ...
                              <form className="comment-form" onSubmit={(e) => { e.preventDefault();  dispatch({type:'sendMessageClose'}); }}>
                                <div className="row">
                                  <div className="col-lg-6">
                                    ...
                                    <label htmlFor="author" className="form-label">  Name <span className="required">*</span> </label>
