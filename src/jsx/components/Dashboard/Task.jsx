									...
									<div className="add-contact-box">
										<div className="add-contact-content">
											...
											<div className="form-group mb-3">
												<label className="form-label">Customer Id</label><span className='required'>*</span>
											...
											<div className="form-group mb-3">
												<label className="form-label">Deadline Date</label><span className='required'>*</span>
												<div className="contact-name">
													<input type="text" className="form-control" autocomplete="off"
											...
											<div className="form-group mb-3">
												<label className="form-label">Client</label><span className='required'>*</span>
											...
											<div className="form-group mb-3">
												<label className="form-label">Location</label><span className='required'>*</span>
												<div className="contact-occupation">
													<input type="text" autocomplete="off"
								...
								<div className="modal-body">
									...
									<div className="add-contact-box">
										<div className="add-contact-content">
											...
											<div className="form-group mb-3">
												<label className="form-label">Deadline Date <span className='required'>*</span></label>
												<div className="contact-name">
													<input type="text" className="form-control" autocomplete="off"
														name="Date_Join" required="required"
						...
						<div className="card project-boxed">
							...
							<div className="card-header align-items-start">
								<div>
									...
									<div className="text-dark fs-14 text-nowrap"><i className="fa fa-calendar me-3" aria-hidden="true"></i>Created on Jan 8th, 2024</div>
								</div>
								<Dropdown className="">
